...
/**
 * @typedef {Object} EmailPreferences
 * @property {boolean} [orderConfirmation]
 ...
 * @property {EmailPreferences} [emailPreferences]
 ...
 * @property {'unpaid'|'paid'|'refunded'} paymentStatus
 * @property {string} [paymentMethod]
 * @property {string} [paidAt]
 * @property {string} [trackingNumber]
 * @property {string} [trackingUrl]
 * @property {string} [lastEmailSentAt]
 * @property {string} [nextEmailRetryAt]
 * @property {string} createdAt
 * @property {string} [updatedAt]
 */
...
export async function getOrdersByUserId(userId, limit = 10, skip = 0) {
  // Use a single query with a join instead of 1+N separate queries
 ...
 * @returns {Promise<Order>}
 */
export async function createOrder(userId, items, total, customer, shippingAddress, orderNumber, paymentMethod = 'card') {
  ...
  const paymentStatus = paymentMethod === 'ramburs' ? 'unpaid' : 'unpaid'
 ...
 * @param {{ trackingNumber?: string, trackingUrl?: string, paymentStatus?: string, paidAt?: string }} [updates]
 * @returns {Promise<Order>}
 */
